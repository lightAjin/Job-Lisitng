...
const AddJobPage = ({addJobSubmit}) => {
    ...
    const [salary, setSalary] = useState('Under 5Lpa');
        ...
        <form onSubmit={submitForm}>
          ...
          <div className="mb-4">
            ...
            <input
              ...
              placeholder="eg. Beautiful Apartment In Pune"
              required
              value={title}
          ...
          <div className="mb-4">
            ...
            >
              <option value="Under 5Lpa">Under 5Lpa</option>
              <option value="5Lpa - 6Lpa">5Lpa - 6Lpa</option>
              ...
              <option value="Over 20Lpa">Over 20Lpa</option>
            </select>
          </div>
